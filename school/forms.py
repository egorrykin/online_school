...
class UserRegistrationForm(UserCreationForm):
    email = forms.EmailField(
        ...
        widget=forms.EmailInput(
            attrs={"class": "form-control", "placeholder": "example@school.ru"}
        ),
    )
    ...
    role = forms.ChoiceField(
        choices=Profile.ROLE_CHOICES, widget=forms.RadioSelect(), label="Выберите роль"
    )
    ...
    class Meta:
        ...
        widgets = {
            "username": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "ivanov2023"}
            ),
...
class AssignmentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "title": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Название задания"}
            ),
            "description": forms.Textarea(
                attrs={
                    "class": "form-control",
...
class AnnouncementForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "title": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Заголовок объявления"}
            ),
            "content": forms.Textarea(
                attrs={
                    "class": "form-control",
